(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function W(a){for(var b;a.length&&a[0]!==document;){b=a.css("position");if("absolute"===b||"relative"===b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}return 0}function R(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass=
...
-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover"))}function I(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function G(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.ui.version="1.12.1";var X=0,U=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,f,e;for(e=0;null!=(f=b[e]);e++)try{(c=d._data(f,"events"))&&c.remove&&
...
typeof h&&(k.guid=h.guid=h.guid||k.guid||d.guid++);var l=c.match(/^([\w:-]*)\s*(.*)$/),m=l[1]+e.eventNamespace;if(l=l[2])f.on(m,l,k);else b.on(m,k)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.off(b).off(b);this.bindings=d(this.bindings.not(a).get());this.focusable=d(this.focusable.not(a).get());this.hoverable=d(this.hoverable.not(a).get())},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"===typeof a?c[a]:a).apply(c,arguments)},
...
getWithinInfo:function(a){var b=d(a||window),c=d.isWindow(b[0]),f=!!b[0]&&9===b[0].nodeType;return{element:b,isWindow:c,isDocument:f,offset:c||f?{left:0,top:0}:d(a).offset(),scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:b.outerWidth(),height:b.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return n.apply(this,arguments);c=d.extend({},c);var m,t,r,u,v,w,x=d(c.of),V=d.position.getWithinInfo(c.within),y=d.position.getScrollInfo(V),C=(c.collision||"flip").split(" "),z={};w=b(x);x[0].preventDefault&&
(c.at="left top");t=w.width;r=w.height;u=w.offset;v=d.extend({},u);d.each(["my","at"],function(){var a=(c[this]||"").split(" "),b,d;1===a.length&&(a=g.test(a[0])?a.concat(["center"]):h.test(a[0])?["center"].concat(a):["center","center"]);a[0]=g.test(a[0])?a[0]:"center";a[1]=h.test(a[1])?a[1]:"center";b=k.exec(a[0]);d=k.exec(a[1]);z[this]=[b?b[0]:0,d?d[0]:0];c[this]=[l.exec(a[0])[0],l.exec(a[1])[0]]});1===C.length&&(C[1]=C[0]);"right"===c.at[0]?v.left+=t:"center"===c.at[0]&&(v.left+=t/2);"bottom"===
c.at[1]?v.top+=r:"center"===c.at[1]&&(v.top+=r/2);m=a(z.at,t,r);v.left+=m[0];v.top+=m[1];return this.each(function(){var b,g,h=d(this),k=h.outerWidth(),l=h.outerHeight(),n=parseInt(d.css(this,"marginLeft"),10)||0,w=parseInt(d.css(this,"marginTop"),10)||0,E=k+n+(parseInt(d.css(this,"marginRight"),10)||0)+y.width,A=l+w+(parseInt(d.css(this,"marginBottom"),10)||0)+y.height,B=d.extend({},v),K=a(z.my,h.outerWidth(),h.outerHeight());"right"===c.my[0]?B.left-=k:"center"===c.my[0]&&(B.left-=k/2);"bottom"===
c.my[1]?B.top-=l:"center"===c.my[1]&&(B.top-=l/2);B.left+=K[0];B.top+=K[1];b={marginLeft:n,marginTop:w};d.each(["left","top"],function(a,f){if(d.ui.position[C[a]])d.ui.position[C[a]][f](B,{targetWidth:t,targetHeight:r,elemWidth:k,elemHeight:l,collisionPosition:b,collisionWidth:E,collisionHeight:A,offset:[m[0]+K[0],m[1]+K[1]],my:c.my,at:c.at,within:V,elem:h})});c.using&&(g=function(a){var b=u.left-B.left,d=b+t-k,g=u.top-B.top,m=g+r-l,v={target:{element:x,left:u.left,top:u.top,width:t,height:r},element:{element:h,
left:B.left,top:B.top,width:k,height:l},horizontal:0>d?"left":0<b?"right":"center",vertical:0>m?"top":0<g?"bottom":"middle"};t<k&&e(b+d)<t&&(v.horizontal="center");r<l&&e(g+m)<r&&(v.vertical="middle");f(e(b),e(d))>f(e(g),e(m))?v.important="horizontal":v.important="vertical";c.using.call(this,a,v)});h.offset(d.extend(B,{using:g}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,e=c.width,g=a.left-b.collisionPosition.marginLeft,c=d-g,h=g+b.collisionWidth-
...
flip:{left:function(a,b){var c=b.within,d=c.offset.left+c.scrollLeft,f=c.width,g=c.isWindow?c.scrollLeft:c.offset.left,h=a.left-b.collisionPosition.marginLeft,c=h-g,k=h+b.collisionWidth-f-g,h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,l="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,m=-2*b.offset[0];if(0>c){if(d=a.left+h+l+m+b.collisionWidth-f-d,0>d||d<e(c))a.left+=h+l+m}else 0<k&&(d=a.left-b.collisionPosition.marginLeft+h+l+m-g,0<d||e(d)<k)&&(a.left+=h+l+m)},
...
h.clip[c[e][1]];"show"===a.mode&&(f.cssClip(h.clip),k&&k.css(d.effects.clipToBox(h)),h.clip=g);k&&k.animate(d.effects.clipToBox(h),a.duration,a.easing);f.animate(h,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("bounce",function(a,b){var c,f,e=d(this),g=a.mode,h="hide"===g;f="show"===g;var k=a.direction||"up",g=a.distance,l=a.times||5,m=2*l+(f||h?1:0),n=a.duration/m,p=a.easing,q="up"===k||"down"===k?"top":"left",k="up"===k||"left"===k,t=0,r=e.queue().length;d.effects.createPlaceholder(e);
c=e.css(q);g||(g=e["top"===q?"outerHeight":"outerWidth"]()/3);f&&(f={opacity:1},f[q]=c,e.css("opacity",0).css(q,k?2*-g:2*g).animate(f,n,p));h&&(g/=Math.pow(2,l-1));f={};for(f[q]=c;t<l;t++)c={},c[q]=(k?"-=":"+=")+g,e.animate(c,n,p).animate(f,n,p),g=h?2*g:g/2;h&&(c={opacity:0},c[q]=(k?"-=":"+=")+g,e.animate(c,n,p));e.queue(b);d.effects.unshift(e,r,m+1)});d.effects.define("clip","hide",function(a,b){var c,f={},e=d(this);c=a.direction||"vertical";var g="both"===c,h=g||"horizontal"===c,g=g||"vertical"===
...
r=Math.ceil(p.outerWidth()/n),u=Math.ceil(p.outerHeight()/m),v=[];for(f=0;f<m;f++)for(h=t.top+f*u,l=f-(m-1)/2,e=0;e<n;e++)g=t.left+e*r,k=e-(n-1)/2,p.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-e*r,top:-f*u}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:r,height:u,left:g+(q?k*r:0),top:h+(q?l*u:0),opacity:q?0:1}).animate({left:g+(q?0:k*r),top:h+(q?0:l*u),opacity:q?1:0},a.duration||500,a.easing,c)});d.effects.define("fade",
"toggle",function(a,b){var c="show"===a.mode;d(this).css("opacity",c?0:1).animate({opacity:c?1:0},{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("fold","hide",function(a,b){var c=d(this),f=a.mode,e="show"===f,f="hide"===f,g=a.size||15,h=/([0-9]+)%/.exec(g),k=a.horizFirst?["right","bottom"]:["bottom","right"],l=a.duration/2,m=d.effects.createPlaceholder(c),n=c.cssClip(),p={clip:d.extend({},n)},q={clip:d.extend({},n)},t=[n[k[0]],n[k[1]]],r=c.queue().length;h&&(g=parseInt(h[1],
10)/100*t[f?0:1]);p.clip[k[0]]=g;q.clip[k[0]]=g;q.clip[k[1]]=0;e&&(c.cssClip(q.clip),m&&m.css(d.effects.clipToBox(q)),q.clip=n);c.queue(function(b){m&&m.animate(d.effects.clipToBox(p),l,a.easing).animate(d.effects.clipToBox(q),l,a.easing);b()}).animate(p,l,a.easing).animate(q,l,a.easing).queue(b);d.effects.unshift(c,r,4)});d.effects.define("highlight","show",function(a,b){var c=d(this),f={backgroundColor:c.css("backgroundColor")};"hide"===a.mode&&(f.opacity=0);d.effects.saveStyle(c);c.css({backgroundImage:"none",
backgroundColor:a.color||"#ffff99"}).animate(f,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("size",function(a,b){var c,f,e,g,h,k,l=d(this),m=["fontSize"],n=["borderTopWidth","borderBottomWidth","paddingTop","paddingBottom"],p=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"];k=a.mode;var q="effect"!==k,t=a.scale||"both";h=a.origin||["middle","center"];var r=l.css("position"),u=l.position(),v=d.effects.scaledDimensions(l),w=a.from||v,x=a.to||d.effects.scaledDimensions(l,
0);d.effects.createPlaceholder(l);"show"===k&&(k=w,w=x,x=k);e=w.height/v.height;g=w.width/v.width;c=x.height/v.height;f=x.width/v.width;if("box"===t||"both"===t)e!==c&&(w=d.effects.setTransition(l,n,e,w),x=d.effects.setTransition(l,n,c,x)),g!==f&&(w=d.effects.setTransition(l,p,g,w),x=d.effects.setTransition(l,p,f,x));"content"!==t&&"both"!==t||e===c||(w=d.effects.setTransition(l,m,e,w),x=d.effects.setTransition(l,m,c,x));h&&(h=d.effects.getBaseline(h,v),w.top=(v.outerHeight-w.outerHeight)*h.y+u.top,
w.left=(v.outerWidth-w.outerWidth)*h.x+u.left,x.top=(v.outerHeight-x.outerHeight)*h.y+u.top,x.left=(v.outerWidth-x.outerWidth)*h.x+u.left);l.css(w);if("content"===t||"both"===t)n=n.concat(["marginTop","marginBottom"]).concat(m),p=p.concat(["marginLeft","marginRight"]),l.find("*[width]").each(function(){var b=d(this),h=d.effects.scaledDimensions(b),k={height:h.height*e,width:h.width*g,outerHeight:h.outerHeight*e,outerWidth:h.outerWidth*g},h={height:h.height*c,width:h.width*f,outerHeight:h.height*c,
outerWidth:h.width*f};e!==c&&(k=d.effects.setTransition(b,n,e,k),h=d.effects.setTransition(b,n,c,h));g!==f&&(k=d.effects.setTransition(b,p,g,k),h=d.effects.setTransition(b,p,f,h));q&&d.effects.saveStyle(b);b.css(k);b.animate(h,a.duration,a.easing,function(){q&&d.effects.restoreStyle(b)})});l.animate(x,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){var a=l.offset();0===x.opacity&&l.css("opacity",w.opacity);q||(l.css("position","static"===r?"relative":r).offset(a),d.effects.saveStyle(l));
...
e||"down"===e?"top":"left",e="up"===e||"left"===e,n={},p={},q={},t=f.queue().length;d.effects.createPlaceholder(f);n[m]=(e?"-=":"+=")+g;p[m]=(e?"+=":"-=")+2*g;q[m]=(e?"-=":"+=")+2*g;for(f.animate(n,l,a.easing);c<h;c++)f.animate(p,l,a.easing).animate(q,l,a.easing);f.animate(p,l,a.easing).animate(n,l/2,a.easing).queue(b);d.effects.unshift(f,t,k+1)});d.effects.define("slide","show",function(a,b){var c,f,e=d(this),g={up:["bottom","top"],down:["top","bottom"],left:["right","left"],right:["left","right"]},
...
null,a)}});d.ui.safeActiveElement=function(a){var b;try{b=a.activeElement}catch(c){b=a.body}b||(b=a.body);b.nodeName||(b=a.body);return b};d.widget("ui.menu",{version:"1.12.1",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-caret-1-e"},items:"> *",menus:"ul",position:{my:"left top",at:"right top"},role:"menu",blur:null,focus:null,select:null},_create:function(){this.activeMenu=this.element;this.mouseHandled=!1;this.element.uniqueId().attr({role:this.options.role,tabIndex:0});this._addClass("ui-menu",
...
d("<input type='text' id='"+a+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.on("keydown",this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));I(a.settings,f||{});b=b&&b.constructor===Date?this._formatDate(a,b):b;this._dialogInput.val(b);this._pos=e?e.length?e:[e.pageX,e.pageY]:null;this._pos||(b=document.documentElement.clientWidth,f=document.documentElement.clientHeight,
...
k.settings):this._get(k,b):null;f=b||{};"string"===typeof b&&(f={},f[b]=c);k&&(this._curInst===k&&this._hideDatepicker(),e=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),I(k.settings,f),null!==g&&void 0!==f.dateFormat&&void 0===f.minDate&&(k.settings.minDate=this._formatDate(k,g)),null!==h&&void 0!==f.dateFormat&&void 0===f.maxDate&&(k.settings.maxDate=this._formatDate(k,h)),"disabled"in f&&(f.disabled?this._disableDatepicker(a):this._enableDatepicker(a)),
...
"static":f?"fixed":"absolute",display:"none",left:c.left+"px",top:c.top+"px"}),!b.inline)){c=d.datepicker._get(b,"showAnim");e=d.datepicker._get(b,"duration");b.dpDiv.css("z-index",W(d(a))+1);d.datepicker._datepickerShowing=!0;if(d.effects&&d.effects.effect[c])b.dpDiv.show(c,d.datepicker._get(b,"showOptions"),e);else b.dpDiv[c||"show"](c?e:null);d.datepicker._shouldFocusInput(b)&&b.input.trigger("focus");d.datepicker._curInst=b}}},_updateDatepicker:function(a){this.maxRows=4;F=a;a.dpDiv.empty().append(this._generateHTML(a));
this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),f=c[1],e=a.dpDiv.find("."+this._dayOverClass+" a");0<e.length&&T.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<f&&a.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");a.dpDiv[(this._get(a,"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");a===d.datepicker._curInst&&d.datepicker._datepickerShowing&&
...
var f,e,g,h=0;e=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff;e="string"!==typeof e?e:(new Date).getFullYear()%100+parseInt(e,10);g=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(c?c.dayNames:null)||this._defaults.dayNames,l=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,m=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,q=-1,t=!1,r,u=function(b){(b=f+1<a.length&&a.charAt(f+1)===b)&&f++;return b},v=function(a){var c=u(a),c="@"===a?14:"!"===a?20:
...
a.charAt(f))throw"Unexpected literal at position "+h;h++};for(f=0;f<a.length;f++)if(t)"'"!==a.charAt(f)||u("'")?x():t=!1;else switch(a.charAt(f)){case "d":p=v("d");break;case "D":w("D",g,k);break;case "o":q=v("o");break;case "m":n=v("m");break;case "M":n=w("M",l,m);break;case "y":c=v("y");break;case "@":r=new Date(v("@"));c=r.getFullYear();n=r.getMonth()+1;p=r.getDate();break;case "!":r=new Date((v("!")-this._ticksTo1970)/1E4);c=r.getFullYear();n=r.getMonth()+1;p=r.getDate();break;case "'":u("'")?
x():t=!0;break;default:x()}if(h<b.length&&(g=b.substr(h),!/^\s+/.test(g)))throw"Extra/unparsed characters found in date: "+g;-1===c?c=(new Date).getFullYear():100>c&&(c+=(new Date).getFullYear()-(new Date).getFullYear()%100+(c<=e?0:-100));if(-1<q){n=1;p=q;do{e=this._getDaysInMonth(c,n-1);if(p<=e)break;n++;p-=e}while(1)}r=this._daylightSavingAdjust(new Date(c,n-1,p));if(r.getFullYear()!==c||r.getMonth()+1!==n||r.getDate()!==p)throw"Invalid date";return r},ATOM:"yy-mm-dd",COOKIE:"D, dd M yy",ISO_8601:"yy-mm-dd",
...
this,"M");return!1},selectYear:function(){d.datepicker._selectMonthYear(c,this,"Y");return!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,d,e,g,h,k,l,m,n,p,q,t,r,u,v,w,x,F,y,C,z,G,I,P,N,J,L=new Date,L=this._daylightSavingAdjust(new Date(L.getFullYear(),L.getMonth(),L.getDate())),H=this._get(a,"isRTL");h=this._get(a,"showButtonPanel");d=this._get(a,"hideIfNoPrevNext");g=this._get(a,"navigationAsDateFormat");var E=this._getNumberOfMonths(a),A=this._get(a,"showCurrentAtPos");
e=this._get(a,"stepMonths");var B=1!==E[0]||1!==E[1],K=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),O=this._getMinMaxDate(a,"min"),M=this._getMinMaxDate(a,"max"),A=a.drawMonth-A,D=a.drawYear;0>A&&(A+=12,D--);if(M)for(b=this._daylightSavingAdjust(new Date(M.getFullYear(),M.getMonth()-E[0]*E[1]+1,M.getDate())),b=O&&b<O?O:b;this._daylightSavingAdjust(new Date(D,A,1))>b;)A--,0>A&&(A=11,D--);a.drawMonth=A;a.drawYear=D;b=this._get(a,"prevText");
...
this._daylightSavingAdjust(new Date(D,A+e,1)),this._getFormatConfig(a)):c;d=this._canAdjustMonth(a,1,D,A)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"w":"e")+"'>"+c+"</span></a>":d?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"w":"e")+"'>"+c+"</span></a>";e=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&
a.currentDay?K:L;e=g?this.formatDate(e,c,this._getFormatConfig(a)):e;g=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+"</button>";h=h?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(H?g:"")+(this._isInRange(a,c)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+
e+"</button>":"")+(H?"":g)+"</div>":"";g=parseInt(this._get(a,"firstDay"),10);g=isNaN(g)?0:g;e=this._get(a,"showWeek");c=this._get(a,"dayNames");k=this._get(a,"dayNamesMin");l=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");n=this._get(a,"beforeShowDay");p=this._get(a,"showOtherMonths");q=this._get(a,"selectOtherMonths");t=this._getDefaultDate(a);r="";for(v=0;v<E[0];v++){w="";this.maxRows=4;for(x=0;x<E[1];x++){F=this._daylightSavingAdjust(new Date(D,A,a.selectedDay));u=" ui-corner-all";
y="";if(B){y+="<div class='ui-datepicker-group";if(1<E[1])switch(x){case 0:y+=" ui-datepicker-group-first";u=" ui-corner-"+(H?"right":"left");break;case E[1]-1:y+=" ui-datepicker-group-last";u=" ui-corner-"+(H?"left":"right");break;default:y+=" ui-datepicker-group-middle",u=""}y+="'>"}y+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+u+"'>"+(/all|left/.test(u)&&0===v?H?d:b:"")+(/all|right/.test(u)&&0===v?H?b:d:"")+this._generateMonthYearHeader(a,A,D,O,M,0<v||0<x,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";
C=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(u=0;7>u;u++)z=(u+g)%7,C+="<th scope='col'"+(5<=(u+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[z]+"'>"+k[z]+"</span></th>";y+=C+"</tr></thead><tbody>";C=this._getDaysInMonth(D,A);D===a.selectedYear&&A===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,C));u=(this._getFirstDayOfMonth(D,A)-g+7)%7;C=Math.ceil((u+C)/7);this.maxRows=C=B?this.maxRows>C?this.maxRows:C:C;z=this._daylightSavingAdjust(new Date(D,
A,1-u));for(G=0;G<C;G++){y+="<tr>";I=e?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(z)+"</td>":"";for(u=0;7>u;u++)P=n?n.apply(a.input?a.input[0]:null,[z]):[!0,""],J=(N=z.getMonth()!==A)&&!q||!P[0]||O&&z<O||M&&z>M,I+="<td class='"+(5<=(u+g+6)%7?" ui-datepicker-week-end":"")+(N?" ui-datepicker-other-month":"")+(z.getTime()===F.getTime()&&A===a.selectedMonth&&a._keyEvent||t.getTime()===z.getTime()&&t.getTime()===F.getTime()?" "+this._dayOverClass:"")+(J?" "+this._unselectableClass+
" ui-state-disabled":"")+(N&&!p?"":" "+P[1]+(z.getTime()===K.getTime()?" "+this._currentClass:"")+(z.getTime()===L.getTime()?" ui-datepicker-today":""))+"'"+(N&&!p||!P[2]?"":" title='"+P[2].replace(/'/g,"&#39;")+"'")+(J?"":" data-handler='selectDay' data-event='click' data-month='"+z.getMonth()+"' data-year='"+z.getFullYear()+"'")+">"+(N&&!p?"&#xa0;":J?"<span class='ui-state-default'>"+z.getDate()+"</span>":"<a class='ui-state-default"+(z.getTime()===L.getTime()?" ui-state-highlight":"")+(z.getTime()===
K.getTime()?" ui-state-active":"")+(N?" ui-priority-secondary":"")+"' href='#'>"+z.getDate()+"</a>")+"</td>",z.setDate(z.getDate()+1),z=this._daylightSavingAdjust(z);y+=I+"</tr>"}A++;11<A&&(A=0,D++);y+="</tbody></table>"+(B?"</div>"+(0<E[0]&&x===E[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");w+=y}r+=w}a._keyEvent=!1;return r+h},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,n,p=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),t=this._get(a,"showMonthAfterYear"),r="<div class='ui-datepicker-title'>",
u="";if(g||!p)u+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;u+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!l||m<=e.getMonth())&&(u+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>");u+="</select>"}t||(r+=u+(!g&&p&&q?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!q)r+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=
...
a.yearshtml+="</select>";r+=a.yearshtml;a.yearshtml=null}r+=this._get(a,"yearSuffix");t&&(r+=(!g&&p&&q?"":"&#xa0;")+u);return r+"</div>"},_adjustInstDate:function(a,b,c){var d=a.selectedYear+("Y"===c?b:0),e=a.selectedMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();"M"!==c&&"Y"!==c||this._notifyChange(a)},
...
drag:function(a,b,c){var f,e,g,h,k,l,m,n,p,q,t=c.options,r=t.snapTolerance,u=b.offset.left,v=u+c.helperProportions.width,w=b.offset.top,x=w+c.helperProportions.height;for(p=c.snapElements.length-1;0<=p;p--)k=c.snapElements[p].left-c.margins.left,l=k+c.snapElements[p].width,m=c.snapElements[p].top-c.margins.top,n=m+c.snapElements[p].height,v<k-r||u>l+r||x<m-r||w>n+r||!d.contains(c.snapElements[p].item.ownerDocument,c.snapElements[p].item)?(c.snapElements[p].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,
a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=!1):("inner"!==t.snapMode&&(f=Math.abs(m-x)<=r,e=Math.abs(n-w)<=r,g=Math.abs(k-v)<=r,h=Math.abs(l-u)<=r,f&&(b.position.top=c._convertPositionTo("relative",{top:m-c.helperProportions.height,left:0}).top),e&&(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k-c.helperProportions.width}).left),h&&(b.position.left=c._convertPositionTo("relative",
{top:0,left:l}).left)),q=f||e||g||h,"outer"!==t.snapMode&&(f=Math.abs(m-w)<=r,e=Math.abs(n-x)<=r,g=Math.abs(k-u)<=r,h=Math.abs(l-v)<=r,f&&(b.position.top=c._convertPositionTo("relative",{top:m,left:0}).top),e&&(b.position.top=c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left)),!c.snapElements[p].snapping&&
...
"ui-dialog-buttons"):(d.each(b,function(b,f){var e,g;f=d.isFunction(f)?{click:f,text:b}:f;f=d.extend({type:"button"},f);e=f.click;g={icon:f.icon,iconPosition:f.iconPosition,showLabel:f.showLabel,icons:f.icons,text:f.text};delete f.click;delete f.icon;delete f.iconPosition;delete f.showLabel;delete f.icons;"boolean"===typeof f.text&&delete f.text;d("<button></button>",f).button(g).appendTo(a.uiButtonSet).on("click",function(){e.apply(a.element[0],arguments)})}),this._addClass(this.uiDialog,"ui-dialog-buttons"),
...
b){var c=!1;d.each((d.ui.ddmanager.droppables[a.options.scope]||[]).slice(),function(){this.options&&(!this.options.disabled&&this.visible&&Q(a,this,this.options.tolerance,b)&&(c=this._drop.call(this,b)||c),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],a.currentItem||a.element)&&(this.isout=!0,this.isover=!1,this._deactivate.call(this,b)))});return c},dragStart:function(a,b){a.element.parentsUntil("body").on("scroll.droppable",function(){a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,
b)})},drag:function(a,b){a.options.refreshPositions&&d.ui.ddmanager.prepareOffsets(a,b);d.each(d.ui.ddmanager.droppables[a.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var c,f,e;e=Q(a,this,this.options.tolerance,b);var g=!e&&this.isover?"isout":e&&!this.isover?"isover":null;g&&(this.options.greedy&&(f=this.options.scope,e=this.element.parents(":data(ui-droppable)").filter(function(){return d(this).droppable("instance").options.scope===f}),e.length&&(c=
d(e[0]).droppable("instance"),c.greedyChild="isover"===g)),c&&"isover"===g&&(c.isover=!1,c.isout=!0,c._out.call(c,b)),this[g]=!0,this["isout"===g?"isover":"isout"]=!1,this["isover"===g?"_over":"_out"].call(this,b),c&&"isout"===g&&(c.isout=!1,c.isover=!0,c._over.call(c,b)))}})},dragStop:function(a,b){a.element.parentsUntil("body").off("scroll.droppable");a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,b)}};!1!==d.uiBackCompat&&d.widget("ui.droppable",d.ui.droppable,{options:{hoverClass:!1,
...
this.button=d("<span>",{tabindex:this.options.disabled?-1:0,id:this.ids.button,role:"combobox","aria-expanded":"false","aria-autocomplete":"list","aria-owns":this.ids.menu,"aria-haspopup":"true",title:this.element.attr("title")}).insertAfter(this.element);this._addClass(this.button,"ui-selectmenu-button ui-selectmenu-button-closed","ui-button ui-widget");a=d("<span>").appendTo(this.button);this._addClass(a,"ui-selectmenu-icon","ui-icon "+this.options.icons.button);this.buttonItem=this._renderButtonItem(c).appendTo(this.button);
...
this,f="";d.each(b,function(b,g){var h;g.optgroup!==f&&(h=d("<li>",{text:g.optgroup}),c._addClass(h,"ui-selectmenu-optgroup","ui-menu-divider"+(g.element.parent("optgroup").prop("disabled")?" ui-state-disabled":"")),h.appendTo(a),f=g.optgroup);c._renderItemData(a,g)})},_renderItemData:function(a,b){return this._renderItem(a,b).data("ui-selectmenu-item",b)},_renderItem:function(a,b){var c=d("<li>"),f=d("<div>",{title:b.element.attr("title")});b.disabled&&this._addClass(c,null,"ui-state-disabled");
this._setText(f,b.label);return c.append(f).appendTo(a)},_setText:function(a,b){b?a.text(b):a.html("&#160;")},_move:function(a,b){var c,d=".ui-menu-item";this.isOpen?c=this.menuItems.eq(this.focusIndex).parent("li"):(c=this.menuItems.eq(this.element[0].selectedIndex).parent("li"),d+=":not(.ui-state-disabled)");c="first"===a||"last"===a?c["first"===a?"prevAll":"nextAll"](d).eq(-1):c[a+"All"](d).eq(0);c.length&&this.menuInstance.focus(b,c)},_getSelectedItem:function(){return this.menuItems.eq(this.element[0].selectedIndex).parent("li")},
...
this._super(a,b);switch(a){case "orientation":this._detectOrientation();this._removeClass("ui-slider-horizontal ui-slider-vertical")._addClass("ui-slider-"+this.orientation);this._refreshValue();this.options.range&&this._refreshRange(b);this.handles.css("horizontal"===b?"bottom":"left","");break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(--c;0<=c;c--)this._change(null,c);this._animateOff=
...
"ui-sortable-handle");d.each(this.items,function(){a._addClass(this.instance.options.handle?this.item.find(this.instance.options.handle):this.item,"ui-sortable-handle")})},_destroy:function(){this._mouseDestroy();for(var a=this.items.length-1;0<=a;a--)this.items[a].item.removeData(this.widgetName+"-item");return this},_mouseCapture:function(a,b){var c=null,f=!1,e=this;if(this.reverting||this.options.disabled||"static"===this.options.type)return!1;this._refreshItems(a);d(a.target).parents().each(function(){if(d.data(this,
...
1;0<=b;b--)if(c=this.items[b],f=c.item[0],(e=this._intersectsWithPointer(c))&&c.instance===this.currentContainer&&f!==this.currentItem[0]&&this.placeholder[1===e?"next":"prev"]()[0]!==f&&!d.contains(this.placeholder[0],f)&&("semi-dynamic"===this.options.type?!d.contains(this.element[0],f):1)){this.direction=1===e?"down":"up";if("pointer"===this.options.tolerance||this._intersectsWithSides(c))this._rearrange(a,c);else break;this._trigger("change",a,this._uiHash());break}this._contactContainers(a);
...
a.connected),c=[];a=a||{};b.each(function(){c.push(d(a.item||this).attr(a.attribute||"id")||"")});return c},_intersectsWith:function(a){var b=this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,e=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,l=k+a.height,m=this.offset.click.top,n=this.offset.click.left,n="y"===this.options.axis||b+n>g&&b+n<h,m=("x"===this.options.axis||d+m>k&&d+m<l)&&n;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||
...
!1===this._trigger("spin",b,{value:c})||(this._value(c),this.counter++)},_increment:function(a){var b=this.options.incremental;return b?d.isFunction(b)?b(a):Math.floor(a*a*a/5E4-a*a/500+17*a/200+1):1},_precision:function(){var a=this._precisionOf(this.options.step);null!==this.options.min&&(a=Math.max(a,this._precisionOf(this.options.min)));return a},_precisionOf:function(a){a=a.toString();var b=a.indexOf(".");return-1===b?0:a.length-b-1},_adjustValue:function(a){var b,c=this.options;b=null!==c.min?
...
load:null},_isLocal:function(){var a=/#.*$/;return function(b){var c,d;c=b.href.replace(a,"");d=location.href.replace(a,"");try{c=decodeURIComponent(c)}catch(e){}try{d=decodeURIComponent(d)}catch(g){}return 1<b.hash.length&&c===d}}(),_create:function(){var a=this,b=this.options;this.running=!1;this._addClass("ui-tabs","ui-widget ui-widget-content");this._toggleClass("ui-tabs-collapsible",null,b.collapsible);this._processTabs();b.active=this._initialActive();d.isArray(b.disabled)&&(b.disabled=d.unique(b.disabled.concat(d.map(this.tabs.filter(".ui-state-disabled"),
function(b){return a.tabs.index(b)}))).sort());this.active=!1!==this.options.active&&this.anchors.length?this._findActive(b.active):d();this._refresh();this.active.length&&this.load(b.active)},_initialActive:function(){var a=this.options.active,b=this.options.collapsible,c=location.hash.substring(1);null===a&&(c&&this.tabs.each(function(b,e){if(d(e).attr("aria-controls")===c)return a=b,!1}),null===a&&(a=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),null===a||-1===a)&&(a=this.tabs.length?0:
!1);!1!==a&&(a=this.tabs.index(this.tabs.eq(a)),-1===a&&(a=b?!1:0));!b&&!1===a&&this.anchors.length&&(a=0);return a},_getCreateEventData:function(){return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):d()}},_tabKeydown:function(a){var b=d(d.ui.safeActiveElement(this.document[0])).closest("li"),c=this.tabs.index(b),f=!0;if(!this._handlePageNav(a)){switch(a.keyCode){case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:c++;break;case d.ui.keyCode.UP:case d.ui.keyCode.LEFT:f=!1;
c--;break;case d.ui.keyCode.END:c=this.anchors.length-1;break;case d.ui.keyCode.HOME:c=0;break;case d.ui.keyCode.SPACE:a.preventDefault();clearTimeout(this.activating);this._activate(c);return;case d.ui.keyCode.ENTER:a.preventDefault();clearTimeout(this.activating);this._activate(c===this.options.active?!1:c);return;default:return}a.preventDefault();clearTimeout(this.activating);c=this._focusNextTab(c,f);a.ctrlKey||a.metaKey||(b.attr("aria-selected","false"),this.tabs.eq(c).attr("aria-selected","true"),
