(function(q,U){"object"===typeof module&&"object"===typeof module.exports?module.exports=q.document?U(q,!0):function(q){if(!q.document)throw Error("jQuery requires a window with a document");return U(q)}:U(q)})("undefined"!==typeof window?window:this,function(q,U){function Ca(a){var b=!!a&&"length"in a&&a.length,d=c.type(a);return"function"===d||c.isWindow(a)?!1:"array"===d||0===b||"number"===typeof b&&0<b&&b-1 in a}function Da(a,b,d){if(c.isFunction(b))return c.grep(a,function(a,c){return!!b.call(a,
...
u=(c.cssNumber[b]||"px"!==n&&+l)&&Fa.exec(c.css(a,b));if(u&&u[3]!==n){n=n||u[3];d=d||[];u=+l||1;do g=g||".5",u/=g,c.style(a,b,u+n);while(g!==(g=k()/l)&&1!==g&&--h)}d&&(u=+u||+l||0,f=d[1]?u+(d[1]+1)*d[2]:+d[2],e&&(e.unit=n,e.start=u,e.end=f));return f}function kb(a){var b="abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video".split(" ");a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());
...
function ca(){return!1}function qb(){try{return r.activeElement}catch(a){}}function Ja(a,b,d,e,f,g){var h,k;if("object"===typeof b){"string"!==typeof d&&(e=e||d,d=void 0);for(k in b)Ja(a,k,d,e,b[k],g);return a}null==e&&null==f?(f=d,e=d=void 0):null==f&&("string"===typeof d?(f=e,e=void 0):(f=e,e=d,d=void 0));if(!1===f)f=ca;else if(!f)return a;1===g&&(h=f,f=function(a){c().off(a);return h.apply(this,arguments)},f.guid=h.guid||(h.guid=c.guid++));return a.each(function(){c.event.add(this,b,f,e,d)})}function rb(a,
...
f;e++)c.event.add(b,d,h[d][e]);g.data&&(g.data=c.extend({},g.data))}}function W(a,b,d,e){b=vb.apply([],b);var f,g,h,k,l=0,n=a.length,u=n-1,m=b[0],H=c.isFunction(m);if(H||1<n&&"string"===typeof m&&!p.checkClone&&mc.test(m))return a.each(function(c){var f=a.eq(c);H&&(b[0]=m.call(this,c,f.html()));W(f,b,d,e)});if(n&&(k=lb(b,a[0].ownerDocument,!1,a,e),f=k.firstChild,1===k.childNodes.length&&(k=f),f||e)){h=c.map(x(k,"script"),sb);for(g=h.length;l<n;l++)f=k,l!==u&&(f=c.clone(f,!0,!0),g&&c.merge(h,x(f,"script"))),
...
b){var d=c(b.createElement(a)).appendTo(b.body),e=c.css(d[0],"display");d.detach();return e}function da(a){var b=r,d=yb[a];d||(d=xb(a,b),"none"!==d&&d||(ma=(ma||c("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=(ma[0].contentWindow||ma[0].contentDocument).document,b.write(),b.close(),d=xb(a,b),ma.detach()),yb[a]=d);return d}function Ka(a,b){return{get:function(){if(a())delete this.get;else return(this.get=b).apply(this,arguments)}}}function zb(a){if(a in Ab)return a;
...
return l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always)}function Y(a){return c.attr(a,"class")||""}function Ib(a){return function(b,d){"string"!==typeof b&&(d=b,b="*");var e,f=0,g=b.toLowerCase().match(N)||[];if(c.isFunction(d))for(;e=g[f++];)"+"===e.charAt(0)?(e=e.slice(1)||"*",(a[e]=a[e]||[]).unshift(d)):(a[e]=a[e]||[]).push(d)}}function Jb(a,b,d,e){function f(k){var l;g[k]=!0;c.each(a[k]||[],function(a,c){var k=c(b,d,e);if("string"===typeof k&&
!h&&!g[k])return b.dataTypes.unshift(k),f(k),!1;if(h)return!(l=k)});return l}var g={},h=a===La;return f(b.dataTypes[0])||!g["*"]&&f("*")}function Ma(a,b){var d,e,f=c.ajaxSettings.flatOptions||{};for(e in b)void 0!==b[e]&&((f[e]?a:d||(d={}))[e]=b[e]);d&&c.extend(!0,a,d);return a}function qc(a){if(!c.contains(a.ownerDocument||r,a))return!0;for(;a&&1===a.nodeType;){if("none"===(a.style&&a.style.display||c.css(a,"display"))||"hidden"===a.type)return!0;a=a.parentNode}return!1}function Na(a,b,d,e){var f;
...
CHILD:/^:(only|first|last|nth|nth-last)-(child|of-type)(?:\([\x20\t\r\n\f]*(even|odd|(([+-]|)(\d*)n|)[\x20\t\r\n\f]*(?:([+-]|)[\x20\t\r\n\f]*(\d+)|))[\x20\t\r\n\f]*\)|)/i,bool:/^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$/i,needsContext:/^[\x20\t\r\n\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i},la=/^(?:input|select|textarea|button)$/i,ma=/^h\d$/i,Q=/^[^{]+\{\s*\[native \w/,
pa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,da=/[+~]/,qa=/'|\\/g,Z=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),aa=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)},na=function(){fa()};try{ga.apply(I=V.call(E.childNodes),E.childNodes),I[E.childNodes.length].nodeType}catch(sa){ga={apply:I.length?function(a,b){Y.apply(a,V.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=
c-1}}}w=b.support={};va=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};fa=b.setDocument=function(a){var b;a=a?a.ownerDocument||a:E;if(a===v||9!==a.nodeType||!a.documentElement)return v;v=a;G=v.documentElement;M=!va(v);(b=v.defaultView)&&b.top!==b&&(b.addEventListener?b.addEventListener("unload",na,!1):b.attachEvent&&b.attachEvent("onunload",na));w.attributes=f(function(a){a.className="i";return!a.getAttribute("className")});w.getElementsByTagName=f(function(a){a.appendChild(v.createComment(""));
return!a.getElementsByTagName("*").length});w.getElementsByClassName=Q.test(v.getElementsByClassName);w.getById=f(function(a){G.appendChild(a).id=y;return!v.getElementsByName||!v.getElementsByName(y).length});w.getById?(t.find.ID=function(a,b){if("undefined"!==typeof b.getElementById&&M){var c=b.getElementById(a);return c?[c]:[]}},t.filter.ID=function(a){var b=a.replace(Z,aa);return function(a){return a.getAttribute("id")===b}}):(delete t.find.ID,t.filter.ID=function(a){var b=a.replace(Z,aa);return function(a){return(a=
...
z=[];A=[];if(w.qsa=Q.test(v.querySelectorAll))f(function(a){G.appendChild(a).innerHTML="<a id='"+y+"'></a><select id='"+y+"-\r\\' msallowcapture=''><option selected=''></option></select>";a.querySelectorAll("[msallowcapture^='']").length&&A.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||A.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll("[id~="+
y+"-]").length||A.push("~=");a.querySelectorAll(":checked").length||A.push(":checked");a.querySelectorAll("a#"+y+"+*").length||A.push(".#.+[+~]")}),f(function(a){var b=v.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&A.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||A.push(":enabled",":disabled");a.querySelectorAll("*,:x");A.push(",.*:")});(w.matchesSelector=Q.test(wa=G.matches||
G.webkitMatchesSelector||G.mozMatchesSelector||G.oMatchesSelector||G.msMatchesSelector))&&f(function(a){w.disconnectedMatch=wa.call(a,"div");wa.call(a,"[s!='']:x");z.push("!=",":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")});
A=A.length&&new RegExp(A.join("|"));z=z.length&&new RegExp(z.join("|"));ta=(b=Q.test(G.compareDocumentPosition))||Q.test(G.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&(c.contains?c.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&16))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1};O=b?function(a,b){if(a===b)return ra=!0,0;var c=!a.compareDocumentPosition-!b.compareDocumentPosition;if(c)return c;
...
a[1].replace(Z,aa);a[3]=(a[3]||a[4]||a[5]||"").replace(Z,aa);"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1].slice(0,3)?(a[3]||b.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&b.error(a[0]);return a},PSEUDO:function(a){var b,c=!a[6]&&a[2];if(U.CHILD.test(a[0]))return null;a[3]?a[2]=a[4]||a[5]||"":c&&ka.test(c)&&(b=ua(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,
b),a[2]=c.slice(0,b));return a.slice(0,3)}},filter:{TAG:function(a){var b=a.replace(Z,aa).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=P[a+" "];return b||(b=new RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&P(a,function(a){return b.test("string"===typeof a.className&&a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,c,d){return function(e){e=b.attr(e,
a);if(null==e)return"!="===c;if(!c)return!0;e+="";return"="===c?e===d:"!="===c?e!==d:"^="===c?d&&0===e.indexOf(d):"*="===c?d&&-1<e.indexOf(d):"$="===c?d&&e.slice(-d.length)===d:"~="===c?-1<(" "+e.replace(ca," ")+" ").indexOf(d):"|="===c?e===d||e.slice(0,d.length+1)===d+"-":!1}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,k){var l,m,n,u,q;c=f!==g?"nextSibling":"previousSibling";var p=
b.parentNode,r=h&&b.nodeName.toLowerCase();k=!k&&!h;l=!1;if(p){if(f){for(;c;){for(n=b;n=n[c];)if(h?n.nodeName.toLowerCase()===r:1===n.nodeType)return!1;q=c="only"===a&&!q&&"nextSibling"}return!0}q=[g?p.firstChild:p.lastChild];if(g&&k)for(n=p,m=n[y]||(n[y]={}),m=m[n.uniqueID]||(m[n.uniqueID]={}),l=m[a]||[],l=(u=l[0]===J&&l[1])&&l[2],n=u&&p.childNodes[u];n=++u&&n&&n[c]||(l=u=0)||q.pop();){if(1===n.nodeType&&++l&&n===b){m[a]=[J,u,l];break}}else if(k&&(n=b,m=n[y]||(n[y]={}),m=m[n.uniqueID]||(m[n.uniqueID]=
{}),l=m[a]||[],l=u=l[0]===J&&l[1]),!1===l)for(;(n=++u&&n&&n[c]||(l=u=0)||q.pop())&&((h?n.nodeName.toLowerCase()!==r:1!==n.nodeType)||!++l||(k&&(m=n[y]||(n[y]={}),m=m[n.uniqueID]||(m[n.uniqueID]={}),m[a]=[J,l]),n!==b)););l-=e;return l===d||0===l%d&&0<=l/d}}},PSEUDO:function(a,c){var d,f=t.pseudos[a]||t.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return f[y]?f(c):1<f.length?(d=[a,a,"",c],t.setFilters.hasOwnProperty(a.toLowerCase())?e(function(a,b){for(var d,e=f(a,c),g=e.length;g--;)d=
oa(a,e[g]),a[d]=!(b[d]=e[g])}):function(a){return f(a,0,d)}):f}},pseudos:{not:e(function(a){var b=[],c=[],d=Sa(a.replace(S,"$1"));return d[y]?e(function(a,b,c,e){e=d(a,null,e,[]);for(var f=a.length;f--;)if(c=e[f])a[f]=!(b[f]=c)}):function(a,e,f){b[0]=a;d(b,null,f,c);b[0]=null;return!c.pop()}}),has:e(function(a){return function(c){return 0<b(a,c).length}}),contains:e(function(a){a=a.replace(Z,aa);return function(b){return-1<(b.textContent||b.innerText||N(b)).indexOf(a)}}),lang:e(function(a){ba.test(a||
"")||b.error("unsupported lang: "+a);a=a.replace(Z,aa).toLowerCase();return function(b){var c;do if(c=M?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),c===a||0===c.indexOf(a+"-");while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===G},focus:function(a){return a===v.activeElement&&(!v.hasFocus||v.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:function(a){return!1===
a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!t.pseudos.empty(a)},header:function(a){return ma.test(a.nodeName)},input:function(a){return la.test(a.nodeName)},button:function(a){var b=
...
return a}),gt:n(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};t.pseudos.nth=t.pseudos.eq;for(K in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})t.pseudos[K]=k(K);for(K in{submit:!0,reset:!0})t.pseudos[K]=l(K);m.prototype=t.filters=t.pseudos;t.setFilters=new m;ua=b.tokenize=function(a,c){var d,e,f,g,h,k,l;if(h=R[a+" "])return c?0:h.slice(0);h=a;k=[];for(l=t.preFilter;h;){if(!d||(e=ea.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);d=!1;if(e=ia.exec(h))d=e.shift(),f.push({value:d,
type:e[0].replace(S," ")}),h=h.slice(d.length);for(g in t.filter)!(e=U[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),h=h.slice(d.length));if(!d)break}return c?h.length:h?b.error(a):R(a,k).slice(0)};Sa=b.compile=function(a,b){var c,d=[],e=[],f=L[a+" "];if(!f){b||(b=ua(a));for(c=b.length;c--;)f=C(b[c]),f[y]?d.push(f):e.push(f);f=L(a,D(e,d));f.selector=a}return f};Ob=b.select=function(a,b,c,d){var e,f,g,h,k="function"===typeof a&&a,l=!d&&ua(a=k.selector||a);c=c||[];
...
a||[],!0))},is:function(a){return!!Da(this,"string"===typeof a&&Qb.test(a)?c(a):a||[],!1).length}});var Ta,xc=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(c.fn.init=function(a,b,d){var e;if(!a)return this;d=d||Ta;if("string"===typeof a){e="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&3<=a.length?[null,a,null]:xc.exec(a);if(!e||!e[1]&&b)return!b||b.jquery?(b||d).find(a):this.constructor(b).find(a);if(e[1]){if(b=b instanceof c?b[0]:b,c.merge(this,c.parseHTML(e[1],b&&b.nodeType?b.ownerDocument||b:r,!0)),
...
Ta=c(r);var yc=/^(?:parents|prev(?:Until|All))/,zc={children:!0,contents:!0,next:!0,prev:!0};c.fn.extend({has:function(a){var b,d=c(a,this),e=d.length;return this.filter(function(){for(b=0;b<e;b++)if(c.contains(this,d[b]))return!0})},closest:function(a,b){for(var d,e=0,f=this.length,g=[],h=Qb.test(a)||"string"!==typeof a?c(a,b||this.context):0;e<f;e++)for(d=this[e];d&&d!==b;d=d.parentNode)if(11>d.nodeType&&(h?-1<h.index(d):1===d.nodeType&&c.find.matchesSelector(d,a))){g.push(d);break}return this.pushStack(1<
...
b,c){return ja(a,"parentNode",c)},next:function(a){return eb(a,"nextSibling")},prev:function(a){return eb(a,"previousSibling")},nextAll:function(a){return ja(a,"nextSibling")},prevAll:function(a){return ja(a,"previousSibling")},nextUntil:function(a,b,c){return ja(a,"nextSibling",c)},prevUntil:function(a,b,c){return ja(a,"previousSibling",c)},siblings:function(a){return Pb((a.parentNode||{}).firstChild,a)},children:function(a){return Pb(a.firstChild)},contents:function(a){return c.nodeName(a,"iframe")?
...
c.removeChild(e),a}})();var Ua=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Fa=new RegExp("^(?:([+-])=|)("+Ua+")([a-z%]*)$","i"),I=["Top","Right","Bottom","Left"],Q=function(a,b){a=b||a;return"none"===c.css(a,"display")||!c.contains(a.ownerDocument,a)},O=function(a,b,d,e,f,g,h){var k=0,l=a.length,n=null==d;if("object"===c.type(d))for(k in f=!0,d)O(a,b,k,d[k],!0,g,h);else if(void 0!==e&&(f=!0,c.isFunction(e)||(h=!0),n&&(h?(b.call(a,e),b=null):(n=b,b=function(a,b,d){return n.call(c(a),d)})),b))for(;k<
...
p.attributes=!a.getAttribute(c.expando)})();var C={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:p.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]};C.optgroup=C.option;C.tbody=C.tfoot=C.colgroup=C.caption=
C.thead;C.th=C.td;var kc=/<|&#?\w+;/,ob=/<tbody/i;(function(){var a,b,c=r.createElement("div");for(a in{submit:!0,change:!0,focusin:!0})b="on"+a,(p[a]=b in q)||(c.setAttribute(b,"t"),p[a]=!1===c.attributes[b].expando)})();var Va=/^(?:input|select|textarea)$/i,Bc=/^key/,Cc=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Sb=/^(?:focusinfocus|focusoutblur)$/,Tb=/^([^.]*)(?:\.(.+)|)/;c.event={global:{},add:function(a,b,d,e,f){var g,h,k,l,n,q,m,p,r;if(k=c._data(a)){d.handler&&(l=d,d=l.handler,f=l.selector);
...
f.apply(h,b),(f=g&&h[g])&&f.apply&&la(h)&&(a.result=f.apply(h,b),!1===a.result&&a.preventDefault());a.type=m;if(!(e||a.isDefaultPrevented()||l._default&&!1!==l._default.apply(p.pop(),b))&&la(d)&&g&&d[m]&&!c.isWindow(d)){(f=d[g])&&(d[g]=null);c.event.triggered=m;try{d[m]()}catch(H){}c.event.triggered=void 0;f&&(d[g]=f)}return a.result}},dispatch:function(a){a=c.event.fix(a);var b,d,e,f,g=[],h=L.call(arguments);b=(c._data(this,"events")||{})[a.type]||[];var k=c.event.special[a.type]||{};h[0]=a;a.delegateTarget=
...
typeof a){for(e in a)this.off(e,b,a[e]);return this}if(!1===b||"function"===typeof b)d=b,b=void 0;!1===d&&(d=ca);return this.each(function(){c.event.remove(this,a,d,b)})},trigger:function(a,b){return this.each(function(){c.event.trigger(a,b,this)})},triggerHandler:function(a,b){var d=this[0];if(d)return c.event.trigger(a,b,d,!0)}});var Dc=/ jQuery\d+="(?:null|\d+)"/g,Ub=/<(?:abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video)[\s/>]/i,
Ec=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,Fc=/<script|<style|<link/i,mc=/checked\s*(?:[^=]|=\s*.checked.)/i,lc=/^true\/(.*)/,nc=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,Wa=kb(r).appendChild(r.createElement("div"));c.extend({htmlPrefilter:function(a){return a.replace(Ec,"<$1></$2>")},clone:function(a,b,d){var e,f,g,h,k,l=c.contains(a.ownerDocument,a);p.html5Clone||c.isXMLDoc(a)||!Ub.test("<"+a.nodeName+">")?g=a.cloneNode(!0):(Wa.innerHTML=a.outerHTML,Wa.removeChild(g=
...
n=p.attributes,q=c.event.special;null!=(d=a[h]);h++)if(b||la(d))if(g=(f=d[k])&&l[f]){if(g.events)for(e in g.events)q[e]?c.event.remove(d,e):c.removeEvent(d,e,g.handle);l[f]&&(delete l[f],n||"undefined"===typeof d.removeAttribute?d[k]=void 0:d.removeAttribute(k),B.push(f))}}});c.fn.extend({domManip:W,detach:function(a){return wb(this,a,!0)},remove:function(a){return wb(this,a)},text:function(a){return O(this,function(a){return void 0===a?c.text(this):this.empty().append((this[0]&&this[0].ownerDocument||
r).createTextNode(a))},null,a,arguments.length)},append:function(){return W(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||rb(this,a).appendChild(a)})},prepend:function(){return W(this,arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=rb(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return W(this,arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return W(this,arguments,
function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&c.cleanData(x(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&c.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return c.clone(this,a,b)})},html:function(a){return O(this,function(a){var d=this[0]||{},e=0,f=this.length;if(void 0===a)return 1===d.nodeType?
...
reliableMarginLeft:function(){null==b&&a();return h}}))})();var X,R,Gc=/^(top|right|bottom|left)$/;q.getComputedStyle?(X=function(a){var b=a.ownerDocument.defaultView;b&&b.opener||(b=q);return b.getComputedStyle(a)},R=function(a,b,d){var e,f,g=a.style;f=(d=d||X(a))?d.getPropertyValue(b)||d[b]:void 0;""!==f&&void 0!==f||c.contains(a.ownerDocument,a)||(f=c.style(a,b));d&&!p.pixelMarginRight()&&qa.test(f)&&Vb.test(b)&&(a=g.width,b=g.minWidth,e=g.maxWidth,g.minWidth=g.maxWidth=g.width=f,f=d.width,g.width=
a,g.minWidth=b,g.maxWidth=e);return void 0===f?f:f+""}):Wb.currentStyle&&(X=function(a){return a.currentStyle},R=function(a,b,c){var e,f,g,h=a.style;g=(c=c||X(a))?c[b]:void 0;null==g&&h&&h[b]&&(g=h[b]);if(qa.test(g)&&!Gc.test(b)){c=h.left;if(f=(e=a.runtimeStyle)&&e.left)e.left=a.currentStyle.left;h.left="fontSize"===b?"1em":g;g=h.pixelLeft+"px";h.left=c;f&&(e.left=f)}return void 0===g?g:g+""||"auto"});var Ya=/alpha\([^)]*\)/i,Hc=/opacity\s*=\s*([^)]*)/i,Ic=/^(none|table(?!-c[ea]).+)/,oc=new RegExp("^("+
Ua+")(.*)$","i"),Jc={position:"absolute",visibility:"hidden",display:"block"},Xb={letterSpacing:"0",fontWeight:"400"},Bb=["Webkit","O","Moz","ms"],Ab=r.createElement("div").style;c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=R(a,"opacity");return""===c?"1":c}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":p.cssFloat?"cssFloat":"styleFloat"},
...
typeof a?a?this.show():this.hide():this.each(function(){Q(this)?c(this).show():c(this).hide()})}});c.Tween=F;F.prototype={constructor:F,init:function(a,b,d,e,f,g){this.elem=a;this.prop=d;this.easing=f||c.easing._default;this.options=b;this.start=this.now=this.cur();this.end=e;this.unit=g||(c.cssNumber[d]?"":"px")},cur:function(){var a=F.propHooks[this.prop];return a&&a.get?a.get(this):F.propHooks._default.get(this)},run:function(a){var b,d=F.propHooks[this.prop];this.pos=this.options.duration?b=c.easing[this.easing](a,
this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&this.options.step.call(this.elem,this.now,this);d&&d.set?d.set(this):F.propHooks._default.set(this);return this}};F.prototype.init.prototype=F.prototype;F.propHooks={_default:{get:function(a){return 1!==a.elem.nodeType||null!=a.elem[a.prop]&&null==a.elem.style[a.prop]?a.elem[a.prop]:(a=c.css(a.elem,a.prop,""))&&"auto"!==a?a:0},set:function(a){if(c.fx.step[a.prop])c.fx.step[a.prop](a);
else 1!==a.elem.nodeType||null==a.elem.style[c.cssProps[a.prop]]&&!c.cssHooks[a.prop]?a.elem[a.prop]=a.now:c.style(a.elem,a.prop,a.now+a.unit)}}};F.propHooks.scrollTop=F.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};c.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};c.fx=F.prototype.init;c.fx.step={};var S,ya,Kc=/^(?:toggle|show|hide)$/,Lc=/queueHooks$/;c.Animation=c.extend(D,{tweeners:{"*":[function(a,
b){var c=this.createTween(a,b);jb(c.elem,a,Fa.exec(b),c);return c}]},tweener:function(a,b){c.isFunction(a)?(b=a,a=["*"]):a=a.match(N);for(var d,e=0,f=a.length;e<f;e++)d=a[e],D.tweeners[d]=D.tweeners[d]||[],D.tweeners[d].unshift(b)},prefilters:[function(a,b,d){var e,f,g,h,k,l,n=this,q={},m=a.style,r=a.nodeType&&Q(a),x=c._data(a,"fxshow");d.queue||(h=c._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,k=h.empty.fire,h.empty.fire=function(){h.unqueued||k()}),h.unqueued++,n.always(function(){n.always(function(){h.unqueued--;
...
b[e],Kc.exec(f)){delete b[e];g=g||"toggle"===f;if(f===(r?"hide":"show"))if("show"===f&&x&&void 0!==x[e])r=!0;else continue;q[e]=x&&x[e]||c.style(a,e)}else l=void 0;if(c.isEmptyObject(q))"inline"===("none"===l?da(a.nodeName):l)&&(m.display=l);else for(e in x?"hidden"in x&&(r=x.hidden):x=c._data(a,"fxshow",{}),g&&(x.hidden=!r),r?c(a).show():n.done(function(){c(a).hide()}),n.done(function(){var b;c._removeData(a,"fxshow");for(b in q)c.style(a,b,q[b])}),q)b=Hb(r?x[e]:0,e,n),e in x||(x[e]=b.start,r&&(b.end=
b.start,b.start="width"===e||"height"===e?1:0))}],prefilter:function(a,b){b?D.prefilters.unshift(a):D.prefilters.push(a)}});c.speed=function(a,b,d){var e=a&&"object"===typeof a?c.extend({},a):{complete:d||!d&&b||c.isFunction(a)&&a,duration:a,easing:d&&b||b&&!c.isFunction(b)&&b};e.duration=c.fx.off?0:"number"===typeof e.duration?e.duration:e.duration in c.fx.speeds?c.fx.speeds[e.duration]:c.fx.speeds._default;if(null==e.queue||!0===e.queue)e.queue="fx";e.old=e.complete;e.complete=function(){c.isFunction(e.old)&&
...
0;d.finish=!0;c.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;b<g;b++)e[b]&&e[b].finish&&e[b].finish.call(this);delete d.finish})}});c.each(["toggle","show","hide"],function(a,b){var d=c.fn[b];c.fn[b]=function(a,c,g){return null==a||"boolean"===typeof a?d.apply(this,arguments):this.animate(na(b,!0),a,c,g)}});c.each({slideDown:na("show"),slideUp:na("hide"),slideToggle:na("toggle"),fadeIn:{opacity:"show"},
fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){c.fn[a]=function(a,c,f){return this.animate(b,a,c,f)}});c.timers=[];c.fx.tick=function(){var a,b=c.timers,d=0;for(S=c.now();d<b.length;d++)a=b[d],a()||b[d]!==a||b.splice(d--,1);b.length||c.fx.stop();S=void 0};c.fx.timer=function(a){c.timers.push(a);a()?c.fx.start():c.timers.pop()};c.fx.interval=13;c.fx.start=function(){ya||(ya=q.setInterval(c.fx.tick,c.fx.interval))};c.fx.stop=function(){q.clearInterval(ya);ya=null};c.fx.speeds=
...
"get"in b&&void 0!==(d=b.get(f,"value")))return d;d=f.value;return"string"===typeof d?d.replace(Mc,""):null==d?"":d}}});c.extend({valHooks:{option:{get:function(a){var b=c.find.attr(a,"value");return null!=b?b:c.trim(c.text(a)).replace(Nc," ")}},select:{get:function(a){for(var b,d=a.options,e=a.selectedIndex,f=(a="select-one"===a.type||0>e)?null:[],g=a?e+1:d.length,h=0>e?g:a?e:0;h<g;h++)if(b=d[h],!(!b.selected&&h!==e||(p.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&
...
a.getAttribute("value")?"on":a.value})});var ka,Yb,T=c.expr.attrHandle,Za=/^(?:checked|selected)$/i,V=p.getSetAttribute,za=p.input;c.fn.extend({attr:function(a,b){return O(this,c.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){c.removeAttr(this,a)})}});c.extend({attr:function(a,b,d){var e,f,g=a.nodeType;if(3!==g&&8!==g&&2!==g){if("undefined"===typeof a.getAttribute)return c.prop(a,b,d);1===g&&c.isXMLDoc(a)||(b=b.toLowerCase(),f=c.attrHooks[b]||(c.expr.match.bool.test(b)?
Yb:ka));if(void 0!==d){if(null===d){c.removeAttr(a,b);return}if(f&&"set"in f&&void 0!==(e=f.set(a,d,b)))return e;a.setAttribute(b,d+"");return d}if(f&&"get"in f&&null!==(e=f.get(a,b)))return e;e=c.find.attr(a,b);return null==e?void 0:e}},attrHooks:{type:{set:function(a,b){if(!p.radioValue&&"radio"===b&&c.nodeName(a,"input")){var d=a.value;a.setAttribute("type",b);d&&(a.value=d);return b}}}},removeAttr:function(a,b){var d,e,f=0,g=b&&b.match(N);if(g&&1===a.nodeType)for(;d=g[f++];)e=c.propFix[d]||d,
c.expr.match.bool.test(d)?za&&V||!Za.test(d)?a[e]=!1:a[c.camelCase("default-"+d)]=a[e]=!1:c.attr(a,d,""),a.removeAttribute(V?d:e)}});Yb={set:function(a,b,d){!1===b?c.removeAttr(a,d):za&&V||!Za.test(d)?a.setAttribute(!V&&c.propFix[d]||d,d):a[c.camelCase("default-"+d)]=a[d]=!0;return d}};c.each(c.expr.match.bool.source.match(/\w+/g),function(a,b){var d=T[b]||c.find.attr;za&&V||!Za.test(b)?T[b]=function(a,b,c){var h,k;c||(k=T[b],T[b]=h,h=null!=d(a,b,c)?b.toLowerCase():null,T[b]=k);return h}:T[b]=function(a,
...
c.parseJSON=function(a){if(q.JSON&&q.JSON.parse)return q.JSON.parse(a+"");var b,d=null,e=c.trim(a+"");return e&&!c.trim(e.replace(Rc,function(a,c,e,k){b&&c&&(d=0);if(0===d)return a;b=e||c;d+=!k-!e;return""}))?Function("return "+e)():c.error("Invalid JSON: "+a)};c.parseXML=function(a){var b,d;if(!a||"string"!==typeof a)return null;try{q.DOMParser?(d=new q.DOMParser,b=d.parseFromString(a,"text/xml")):(b=new q.ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a))}catch(e){b=void 0}b&&b.documentElement&&
!b.getElementsByTagName("parsererror").length||c.error("Invalid XML: "+a);return b};var Sc=/#.*$/,Zb=/([?&])_=[^&]*/,Tc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Uc=/^(?:GET|HEAD)$/,Vc=/^\/\//,$b=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,ac={},La={},bc="*/".concat("*"),cb=Qc.href,ba=$b.exec(cb.toLowerCase())||[];c.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:cb,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(ba[1]),global:!0,processData:!0,
async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":bc,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":c.parseJSON,"text xml":c.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Ma(Ma(a,c.ajaxSettings),
b):Ma(c.ajaxSettings,a)},ajaxPrefilter:Ib(ac),ajaxTransport:Ib(La),ajax:function(a,b){function d(a,b,d,e){var f,p,u,w;w=b;if(2!==K){K=2;k&&q.clearTimeout(k);n=void 0;h=e||"";t.readyState=0<a?4:0;e=200<=a&&300>a||304===a;if(d){u=m;for(var v=t,G,M,A,z,B=u.contents,D=u.dataTypes;"*"===D[0];)D.shift(),void 0===M&&(M=u.mimeType||v.getResponseHeader("Content-Type"));if(M)for(z in B)if(B[z]&&B[z].test(M)){D.unshift(z);break}if(D[0]in d)A=D[0];else{for(z in d){if(!D[0]||u.converters[z+" "+D[0]]){A=z;break}G||
(G=z)}A=A||G}A?(A!==D[0]&&D.unshift(A),u=d[A]):u=void 0}a:{d=m;G=u;M=t;A=e;var y,E,J,v={},B=d.dataTypes.slice();if(B[1])for(E in d.converters)v[E.toLowerCase()]=d.converters[E];for(z=B.shift();z;)if(d.responseFields[z]&&(M[d.responseFields[z]]=G),!J&&A&&d.dataFilter&&(G=d.dataFilter(G,d.dataType)),J=z,z=B.shift())if("*"===z)z=J;else if("*"!==J&&J!==z){E=v[J+" "+z]||v["* "+z];if(!E)for(y in v)if(u=y.split(" "),u[1]===z&&(E=v[J+" "+u[0]]||v["* "+u[0]])){!0===E?E=v[y]:!0!==v[y]&&(z=u[0],B.unshift(u[1]));
break}if(!0!==E)if(E&&d["throws"])G=E(G);else try{G=E(G)}catch(L){u={state:"parsererror",error:E?L:"No conversion from "+J+" to "+z};break a}}u={state:"success",data:G}}if(e)m.ifModified&&((w=t.getResponseHeader("Last-Modified"))&&(c.lastModified[g]=w),(w=t.getResponseHeader("etag"))&&(c.etag[g]=w)),204===a||"HEAD"===m.type?w="nocontent":304===a?w="notmodified":(w=u.state,f=u.data,p=u.error,e=!p);else if(p=w,a||!w)w="error",0>a&&(a=0);t.status=a;t.statusText=(b||w)+"";e?C.resolveWith(r,[f,w,t]):C.rejectWith(r,
[t,w,p]);t.statusCode(I);I=void 0;l&&x.trigger(e?"ajaxSuccess":"ajaxError",[t,m,e?f:p]);F.fireWith(r,[t,w]);l&&(x.trigger("ajaxComplete",[t,m]),--c.active||c.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var e,f,g,h,k,l,n,p,m=c.ajaxSetup({},b),r=m.context||m,x=m.context&&(r.nodeType||r.jquery)?c(r):c.event,C=c.Deferred(),F=c.Callbacks("once memory"),I=m.statusCode||{},B={},D={},K=0,w="canceled",t={readyState:0,getResponseHeader:function(a){var b;if(2===K){if(!p)for(p={};b=
Tc.exec(h);)p[b[1].toLowerCase()]=b[2];b=p[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===K?h:null},setRequestHeader:function(a,b){var c=a.toLowerCase();K||(a=D[c]=D[c]||a,B[a]=b);return this},overrideMimeType:function(a){K||(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>K)for(b in a)I[b]=[I[b],a[b]];else t.always(a[t.status]);return this},abort:function(a){a=a||w;n&&n.abort(a);d(0,a);return this}};C.promise(t).complete=F.add;t.success=t.done;
t.error=t.fail;m.url=((a||m.url||cb)+"").replace(Sc,"").replace(Vc,ba[1]+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=c.trim(m.dataType||"*").toLowerCase().match(N)||[""];null==m.crossDomain&&(e=$b.exec(m.url.toLowerCase()),m.crossDomain=!(!e||e[1]===ba[1]&&e[2]===ba[2]&&(e[3]||("http:"===e[1]?"80":"443"))===(ba[3]||("http:"===ba[1]?"80":"443"))));m.data&&m.processData&&"string"!==typeof m.data&&(m.data=c.param(m.data,m.traditional));Jb(ac,m,b,t);if(2===K)return t;(l=c.event&&m.global)&&
0===c.active++&&c.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!Uc.test(m.type);g=m.url;m.hasContent||(m.data&&(g=m.url+=(bb.test(g)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Zb.test(g)?g.replace(Zb,"$1_="+ab++):g+(bb.test(g)?"&":"?")+"_="+ab++));m.ifModified&&(c.lastModified[g]&&t.setRequestHeader("If-Modified-Since",c.lastModified[g]),c.etag[g]&&t.setRequestHeader("If-None-Match",c.etag[g]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&t.setRequestHeader("Content-Type",
m.contentType);t.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+bc+"; q=0.01":""):m.accepts["*"]);for(f in m.headers)t.setRequestHeader(f,m.headers[f]);if(m.beforeSend&&(!1===m.beforeSend.call(r,t,m)||2===K))return t.abort();w="abort";for(f in{success:1,error:1,complete:1})t[f](m[f]);if(n=Jb(La,m,b,t)){t.readyState=1;l&&x.trigger("ajaxSend",[t,m]);if(2===K)return t;m.async&&0<m.timeout&&(k=q.setTimeout(function(){t.abort("timeout")},
m.timeout));try{K=1,n.send(B,d)}catch(L){if(2>K)d(-1,L);else throw L;}}else d(-1,"No Transport");return t},getJSON:function(a,b,d){return c.get(a,b,d,"json")},getScript:function(a,b){return c.get(a,void 0,b,"script")}});c.each(["get","post"],function(a,b){c[b]=function(a,e,f,g){c.isFunction(e)&&(g=g||f,f=e,e=void 0);return c.ajax(c.extend({url:a,type:b,dataType:g,data:e,success:f},c.isPlainObject(a)&&a))}});c._evalUrl=function(a){return c.ajax({url:a,type:"GET",dataType:"script",cache:!0,async:!1,
...
d=b.contents();d.length?d.wrapAll(a):b.append(a)})},wrap:function(a){var b=c.isFunction(a);return this.each(function(d){c(this).wrapAll(b?a.call(this,d):a)})},unwrap:function(){return this.parent().each(function(){c.nodeName(this,"body")||c(this).replaceWith(this.childNodes)}).end()}});c.expr.filters.hidden=function(a){return p.reliableHiddenOffsets()?0>=a.offsetWidth&&0>=a.offsetHeight&&!a.getClientRects().length:qc(a)};c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)};var Wc=/%20/g,
rc=/\[\]$/,cc=/\r?\n/g,Xc=/^(?:submit|button|image|reset|file)$/i,Yc=/^(?:input|select|textarea|keygen)/i;c.param=function(a,b){var d,e=[],f=function(a,b){b=c.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};void 0===b&&(b=c.ajaxSettings&&c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)Na(d,a[d],b,f);return e.join("&").replace(Wc,"+")};c.fn.extend({serialize:function(){return c.param(this.serializeArray())},
...
Kb():8<r.documentMode?Oa():/^(get|post|head|put|delete|options)$/i.test(this.type)&&Oa()||Kb()}:Oa;var Zc=0,Aa={},Ba=c.ajaxSettings.xhr();q.attachEvent&&q.attachEvent("onunload",function(){for(var a in Aa)Aa[a](void 0,!0)});p.cors=!!Ba&&"withCredentials"in Ba;(Ba=p.ajax=!!Ba)&&c.ajaxTransport(function(a){if(!a.crossDomain||p.cors){var b;return{send:function(d,e){var f,g=a.xhr(),h=++Zc;g.open(a.type,a.url,a.async,a.username,a.password);if(a.xhrFields)for(f in a.xhrFields)g[f]=a.xhrFields[f];a.mimeType&&
...
"$1"+e):!1!==a.jsonp&&(a.url+=(bb.test(a.url)?"&":"?")+a.jsonp+"="+e),a.converters["script json"]=function(){g||c.error(e+" was not called");return g[0]},a.dataTypes[0]="json",f=q[e],q[e]=function(){g=arguments},d.always(function(){void 0===f?c(q).removeProp(e):q[e]=f;a[e]&&(a.jsonpCallback=b.jsonpCallback,dc.push(e));g&&c.isFunction(f)&&f(g[0]);g=f=void 0}),"script"});c.parseHTML=function(a,b,d){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(d=b,b=!1);b=b||r;var e=Rb.exec(a);d=!d&&
[];if(e)return[b.createElement(e[1])];e=lb([a],b,d);d&&d.length&&c(d).remove();return c.merge([],e.childNodes)};var ec=c.fn.load;c.fn.load=function(a,b,d){if("string"!==typeof a&&ec)return ec.apply(this,arguments);var e,f,g,h=this,k=a.indexOf(" ");-1<k&&(e=c.trim(a.slice(k,a.length)),a=a.slice(0,k));c.isFunction(b)?(d=b,b=void 0):b&&"object"===typeof b&&(f="POST");0<h.length&&c.ajax({url:a,type:f||"GET",dataType:"html",data:b}).done(function(a){g=arguments;h.html(e?c("<div>").append(c.parseHTML(a)).find(e):
...
a||"**",c)}});c.fn.size=function(){return this.length};c.fn.andSelf=c.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return c});var $c=q.jQuery,ad=q.$;c.noConflict=function(a){q.$===c&&(q.$=ad);a&&q.jQuery===c&&(q.jQuery=$c);return c};U||(q.jQuery=q.$=c);return c});
